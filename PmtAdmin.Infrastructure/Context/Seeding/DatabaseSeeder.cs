        ...
        private static void SeedIssues(ModelBuilder modelBuilder)
{
    ...
    {
        // Project 1 Issues (Scrum - with sprints)
        new Issue { Id = _issueId1, Key = "PROJ001-1", ProjectId = _projectId1, EpicId = _epicId1, SprintId = _sprintId1, Summary = "Issue 1 for Project 1", Title = "Task 1", Description = "Description for issue 1 in project 1", Type = "STORY", Priority = "HIGH", AssigneeId = 4, ReporterId = 1, StoryPoints = 3, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },
        new Issue { Id = _issueId2, Key = "PROJ001-2", ProjectId = _projectId1, EpicId = _epicId1, SprintId = _sprintId1, Summary = "Issue 2 for Project 1", Title = "Task 2", Description = "Description for issue 2 in project 1", Type = "TASK", Priority = "MEDIUM", AssigneeId = 5, ReporterId = 1, StoryPoints = 6, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },
        new Issue { Id = _issueId3, Key = "PROJ001-3", ProjectId = _projectId1, EpicId = _epicId1, SprintId = _sprintId1, Summary = "Issue 3 for Project 1", Title = "Task 3", Description = "Description for issue 3 in project 1", Type = "BUG", Priority = "MEDIUM", AssigneeId = 8, ReporterId = 1, StoryPoints = 9, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },

        // Project 2 Issues (Kanban - no sprints)
        new Issue { Id = _issueId4, Key = "PROJ002-1", ProjectId = _projectId2, EpicId = _epicId2, SprintId = null, Summary = "Issue 1 for Project 2", Title = "Task 1", Description = "Description for issue 1 in project 2", Type = "STORY", Priority = "HIGH", AssigneeId = 4, ReporterId = 1, StoryPoints = 3, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },
        new Issue { Id = _issueId5, Key = "PROJ002-2", ProjectId = _projectId2, EpicId = _epicId2, SprintId = null, Summary = "Issue 2 for Project 2", Title = "Task 2", Description = "Description for issue 2 in project 2", Type = "TASK", Priority = "MEDIUM", AssigneeId = 5, ReporterId = 1, StoryPoints = 6, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },
        new Issue { Id = _issueId6, Key = "PROJ002-3", ProjectId = _projectId2, EpicId = _epicId2, SprintId = null, Summary = "Issue 3 for Project 2", Title = "Task 3", Description = "Description for issue 3 in project 2", Type = "BUG", Priority = "MEDIUM", AssigneeId = 8, ReporterId = 1, StoryPoints = 9, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },

        // Project 3 Issues (Scrum)
        new Issue { Id = _issueId7, Key = "PROJ003-1", ProjectId = _projectId3, EpicId = _epicId3, SprintId = _sprintId2, Summary = "Issue 1 for Project 3", Title = "Task 1", Description = "Description for issue 1 in project 3", Type = "STORY", Priority = "HIGH", AssigneeId = 4, ReporterId = 1, StoryPoints = 3, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },
        new Issue { Id = _issueId8, Key = "PROJ003-2", ProjectId = _projectId3, EpicId = _epicId3, SprintId = _sprintId2, Summary = "Issue 2 for Project 3", Title = "Task 2", Description = "Description for issue 2 in project 3", Type = "TASK", Priority = "MEDIUM", AssigneeId = 5, ReporterId = 1, StoryPoints = 6, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },
        new Issue { Id = _issueId9, Key = "PROJ003-3", ProjectId = _projectId3, EpicId = _epicId3, SprintId = _sprintId2, Summary = "Issue 3 for Project 3", Title = "Task 3", Description = "Description for issue 3 in project 3", Type = "BUG", Priority = "MEDIUM", AssigneeId = 8, ReporterId = 1, StoryPoints = 9, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },

        // Project 4 Issues (Kanban)
        new Issue { Id = _issueId10, Key = "PROJ004-1", ProjectId = _projectId4, EpicId = _epicId4, SprintId = null, Summary = "Issue 1 for Project 4", Title = "Task 1", Description = "Description for issue 1 in project 4", Type = "STORY", Priority = "HIGH", AssigneeId = 4, ReporterId = 1, StoryPoints = 3, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },
        new Issue { Id = _issueId11, Key = "PROJ004-2", ProjectId = _projectId4, EpicId = _epicId4, SprintId = null, Summary = "Issue 2 for Project 4", Title = "Task 2", Description = "Description for issue 2 in project 4", Type = "TASK", Priority = "MEDIUM", AssigneeId = 5, ReporterId = 1, StoryPoints = 6, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },
        new Issue { Id = _issueId12, Key = "PROJ004-3", ProjectId = _projectId4, EpicId = _epicId4, SprintId = null, Summary = "Issue 3 for Project 4", Title = "Task 3", Description = "Description for issue 3 in project 4", Type = "BUG", Priority = "MEDIUM", AssigneeId = 8, ReporterId = 1, StoryPoints = 9, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },

        // Project 5 Issues (Scrum)
        new Issue { Id = _issueId13, Key = "PROJ005-1", ProjectId = _projectId5, EpicId = _epicId5, SprintId = _sprintId3, Summary = "Issue 1 for Project 5", Title = "Task 1", Description = "Description for issue 1 in project 5", Type = "STORY", Priority = "HIGH", AssigneeId = 4, ReporterId = 1, StoryPoints = 3, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },
        new Issue { Id = _issueId14, Key = "PROJ005-2", ProjectId = _projectId5, EpicId = _epicId5, SprintId = _sprintId3, Summary = "Issue 2 for Project 5", Title = "Task 2", Description = "Description for issue 2 in project 5", Type = "TASK", Priority = "MEDIUM", AssigneeId = 5, ReporterId = 1, StoryPoints = 6, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset },
        new Issue { Id = _issueId15, Key = "PROJ005-3", ProjectId = _projectId5, EpicId = _epicId5, SprintId = _sprintId3, Summary = "Issue 3 for Project 5", Title = "Task 3", Description = "Description for issue 3 in project 5", Type = "BUG", Priority = "MEDIUM", AssigneeId = 8, ReporterId = 1, StoryPoints = 9, CreatedBy = 1, CreatedAt = _staticDateOffset, UpdatedAt = _staticDateOffset }
    };
